...
public class BlockEntityInteractor extends BlockMachine{
	...
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
		return new TileEntityEntityInteractor();
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		if(!super.onBlockActivated(world, x, y, z, player, meta, posX, posY, posZ) && !player.isSneaking()){
			player.openGui(MirandaCraft.instance, GuiHandler.GuiIdentifier.ENTITY_INTERACTOR.ordinal(), world, x, y, z);
			return true;
		}
		return false;		
	}
